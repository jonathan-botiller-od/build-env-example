...
RUN wget -O clang-utils.tgz "https://github.com/lmapii/run-clang-format/releases/download/v1.5.0/run-clang-format-v1.5.0-aarch64-unknown-linux-gnu.tar.gz" && \
...
RUN wget -O clang-utils.tgz "https://github.com/lmapii/run-clang-tidy/releases/download/v0.3.0/run-clang-tidy-v0.3.0-aarch64-unknown-linux-gnu.tar.gz" && \
